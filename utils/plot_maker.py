...
def main():
    ...
    iter_val_plot(search_loc_dists, search_dist_axis, 'lhs_110_search_dist')
    ...
    iter_val_plot(search_loc_rel_dists, search_rel_dist_axis, 'lhs_110_search_rel_dist')
    ...
    iter_val_plot(search_loc_orig_dists, search_orig_dist_axis, 'lhs_110_opt_orig_dist')    
    ...
    iter_val_plot(opt_loc_dists, opt_dist_axis, 'lhs_110_opt_dist')
    ...
    iter_val_plot(opt_loc_rel_dists, opt_rel_dist_axis, 'lhs_110_opt_rel_dist')
    ...
    iter_val_plot(opt_loc_orig_dists, opt_orig_dist_axis, 'lhs_110_opt_orig_dist')
    ...
    iter_val_plot(opt_search_dists, opt_search_axis, 'lhs_110_opt_search_dist')
...
def iter_val_plot(all_iter_val, y_label, figname, major_mult=5, minor_mult=1, directory=data_dir):
